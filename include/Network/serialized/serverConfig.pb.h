...
class NetMessage final :
 ...
 public:
  ...
  NetMessage* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  PROTOBUF_NODISCARD ::net::GameServerConfig* release_server_config();
  ...
  PROTOBUF_NODISCARD ::net::ClientInfo* release_client_info();
  ...
  PROTOBUF_NODISCARD ::net::GenerateRoom* release_generate_room_request();
  ...
  PROTOBUF_NODISCARD ::net::ConnectRoom* release_connect_room();
  ...
  PROTOBUF_NODISCARD ::net::GameMessage* release_game_message();
...
class GameServerConfig final :
 ...
 public:
  ...
  GameServerConfig* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
class GenerateRoom final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:net.GenerateRoom) */ {
 public:
  ...
  GenerateRoom* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<GenerateRoom>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyFrom;
  inline void CopyFrom(const GenerateRoom& from) {
...
class GameMessage final :
 ...
 public:
  ...
  PROTOBUF_NODISCARD ::net::PlayerInfo* release_player_info();
  ...
  PROTOBUF_NODISCARD ::net::BoxInfo* release_boxinfo();
...
class PlayerInfo final :
 ...
 public:
  ...
  PROTOBUF_NODISCARD std::string* release_curranim();
  ...
  int32_t currframe() const;
  void set_currframe(int32_t value);
  private:
  int32_t _internal_currframe() const;
  void _internal_set_currframe(int32_t value);
  public:
...
class BoxInfo final :
 ...
 public:
  ...
  void clear_meow();
  int32_t meow() const;
  void set_meow(int32_t value);
  private:
  int32_t _internal_meow() const;
  void _internal_set_meow(int32_t value);
  public:
...
inline uint32_t GameServerConfig::_internal_v4() const {
  if (_internal_has_v4()) {
    return server_address_.v4_;
  }
  return 0u;
}
inline void GameServerConfig::_internal_set_v4(uint32_t value) {
  if (!_internal_has_v4()) {
...
inline uint32_t GameServerConfig::v4() const {
  // @@protoc_insertion_point(field_get:net.GameServerConfig.v4)
  return _internal_v4();
}
inline void GameServerConfig::set_v4(uint32_t value) {
...
inline void GameServerConfig::set_allocated_room_code(std::string* room_code) {
  ...
  if (room_code_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
...
inline uint32_t GameMessage::_internal_game_id() const {
  return game_id_;
}
inline uint32_t GameMessage::game_id() const {
  // @@protoc_insertion_point(field_get:net.GameMessage.game_id)
  return _internal_game_id();
}
inline void GameMessage::_internal_set_game_id(uint32_t value) {
  
  game_id_ = value;
}
inline void GameMessage::set_game_id(uint32_t value) {
...
inline void PlayerInfo::set_allocated_curranim(std::string* curranim) {
  ...
  curranim_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), curranim,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (curranim_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    curranim_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline int32_t PlayerInfo::_internal_currframe() const {
  return currframe_;
}
inline int32_t PlayerInfo::currframe() const {
  // @@protoc_insertion_point(field_get:net.PlayerInfo.currFrame)
  return _internal_currframe();
}
inline void PlayerInfo::_internal_set_currframe(int32_t value) {
  
  currframe_ = value;
}
inline void PlayerInfo::set_currframe(int32_t value) {
...
inline int32_t BoxInfo::_internal_meow() const {
  return meow_;
}
inline int32_t BoxInfo::meow() const {
  // @@protoc_insertion_point(field_get:net.BoxInfo.meow)
  return _internal_meow();
}
inline void BoxInfo::_internal_set_meow(int32_t value) {
  
  meow_ = value;
}
inline void BoxInfo::set_meow(int32_t value) {
